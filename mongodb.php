                ...
                <div class="col-lg-8">
                    ...
                    <div class="courses-details">
                        ...
                        <div class="courses-details-images">
                            <img src="assets/images/courses/mongodb.jpg" alt="Courses Details">
                            <span class="tags">Science</span>

                            <div class="courses-play">
                                <img src="Images/circle-shape.webp" alt="Play">
                                <a class="play video-popup" href="Video/mongodb.php"><i
                                        class="fa fa-play"></i></a>
                            </div>
                        </div>

                        <h2 class="title">MongoDB Tutorial for Beginners Learn MongoDB.
                        </h2>

                        <div class="courses-details-admin">
                            <div class="admin-author">
                                <div class="author-thumb">
                                    <img src="assets/images/author/mongodblogo.jpeg" alt="Author">
                                </div>
                                <div class="author-content">
                                    <a class="name" href="#">ProgrammingKnowledge</a>
                                    ...
                                    <div class="tab-pane fade show active" id="description">
                                        ...
                                        <div class="tab-description">
                                            <div class="description-wrapper">
                                                ...
                                                <p>MongoDB Tutorial for Beginners Learn MongoDB:</p>
                                                
                                            </div>
                                            <div class="description-wrapper">
                                                <h3 class="tab-title">Curriculum:</h3>
                                                <p>Hey  welcome to your very first MongoDB tutorial. MongoDB is one of the most used, open-source document database, and NoSQL database. MongoDB is developed by 10gen. It is written in c++ and it is a document-oriented database. It uses BSON format.
                ...
                <div class="col-lg-4">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-widget widget-information">
                            ...
                            <div class="info-list">
                                <ul>
                                    <li><i class="fa fa-user"></i> <strong>Instructor</strong> <span>ProgrammingKnowledge

                                            </span></li>
                                    <li><i class="fa fa-history"></i> <strong>Duration</strong> <span>15 hr 45
                                            mins</span></li>
                                    <li><i class="fa fa-play"></i> <strong>Lectures</strong> <span>11</span></li>
                            ...
                            <div class="info-btn">
                                <a href="Video/mongodb.php" class="btn btn-primary btn-hover-dark">Enroll Now</a>
                            </div>
                        </div>
