                ...
                <div class="col-lg-8">
                    ...
                    <div class="courses-details">
                        ...
                        <div class="courses-details-images">
                            <img src="assets/images/courses/angular.jpg" alt="Courses Details">
                            <span class="tags">Science</span>

                            <div class="courses-play">
                                <img src="Images/circle-shape.webp" alt="Play">
                                <a class="play video-popup" href="Video/angular.php"><i
                                        class="fa fa-play"></i></a>
                            </div>
                        </div>

                        <h2 class="title">Angular Tutorial For Beginners| What Is Angular And How It Works? | Simplilearn.
                        </h2>
                                    ...
                                    <div class="tab-pane fade show active" id="description">
                                        ...
                                        <div class="tab-description">
                                            <div class="description-wrapper">
                                                ...
                                                <p>Complete Angular Course To Learn:</p>
                                                
                                            </div>
                                            <div class="description-wrapper">
                                                <h3 class="tab-title">Curriculum:</h3>
                                                <p>In this course on What is Angular, you will be introduced to Angular and some of the basic concepts to begin your Angular journey. Angular is a front-end JavaScript framework used to develop Web and Single-page applications. The Angular framework is commonly used to create Single Page Applications. 
                                                </p>
                                            </div>
                                            <!--<div class="description-wrapper">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-widget widget-information">
                            ...
                            <div class="info-list">
                                <ul>
                                    <li><i class="fa fa-user"></i> <strong>Instructor</strong> <span>Simplilearn
                                            </span></li>
                                    <li><i class="fa fa-history"></i> <strong>Duration</strong> <span>20 hr 5
                                            mins</span></li>
                                    <li><i class="fa fa-play"></i> <strong>Lectures</strong> <span>21</span></li>
                            ...
                            <div class="info-btn">
                                <a href="Video/angular.php" class="btn btn-primary btn-hover-dark">Enroll Now</a>
                            </div>
                        </div>
