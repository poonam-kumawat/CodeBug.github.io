                ...
                <div class="col-lg-4">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-widget widget-information">
                            ...
                            <div class="info-list">
                                <ul>
                                    <li><i class="fa fa-user"></i> <strong>Instructor</strong> <span>Traversy
                                            Media</span></li>
                                    <li><i class="fa fa-history"></i> <strong>Duration</strong> <span>08 hr 15
                                            mins</span></li>
                                    <li><i class="fa fa-play"></i> <strong>Lectures</strong> <span>22</span></li>
