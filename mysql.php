                ...
                <div class="col-lg-8">
                    ...
                    <div class="courses-details">
                        ...
                        <div class="courses-details-images">
                            <img src="assets/images/courses/mysql.jpg" alt="Courses Details">
                            <span class="tags">Science</span>

                            <div class="courses-play">
                                <img src="Images/circle-shape.webp" alt="Play">
                                <a class="play video-popup" href="Video/mysql.php"><i
                                        class="fa fa-play"></i></a>
                            </div>
                        </div>

                        <h2 class="title">MySQL With Python And Data Science.
                        </h2>

                        <div class="courses-details-admin">
                            <div class="admin-author">
                                <div class="author-thumb">
                                    <img src="assets/images/author/mysqllogo.jpg" alt="Author">
                                </div>
                                    ...
                                    <div class="tab-pane fade show active" id="description">
                                        ...
                                        <div class="tab-description">
                                            <div class="description-wrapper">
                                                ...
                                                <p>MySQL With Python And Data Science:</p>
                                                
                                            </div>
                                            <div class="description-wrapper">
                                                <h3 class="tab-title">Curriculum:</h3>
                                                <p>Python MySQL Connector is a Python driver that helps to integrate Python and MySQL. This Python MySQL library allows the conversion between Python and MySQL data types. MySQL Connector API is implemented using pure Python and does not require any third-party library.  
                                                </p>
                                            </div>
                                            <!--<div class="description-wrapper">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-widget widget-information">
                            ...
                            <div class="info-list">
                                <ul>
                                    <li><i class="fa fa-user"></i> <strong>Instructor</strong> <span>Krish Naik

                                            </span></li>
                                    <li><i class="fa fa-history"></i> <strong>Duration</strong> <span>10 hr 45
                                            mins</span></li>
                            ...
                            <div class="info-btn">
                                <a href="Video/htmlcss.php" class="btn btn-primary btn-hover-dark">Enroll Now</a>
                            </div>
                        </div>
