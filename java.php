                ...
                <div class="col-lg-8">
                    ...
                    <div class="courses-details">
                        ...
                        <div class="courses-details-images">
                            <img src="assets/images/courses/java.jpg" alt="Courses Details">
                            <span class="tags">Science</span>

                            <div class="courses-play">
                                <img src="Images/circle-shape.webp" alt="Play">
                                <a class="play video-popup" href="Video/java.php"><i
                                        class="fa fa-play"></i></a>
                            </div>
                        </div>

                        <h2 class="title">Introduction to Java Language | Lecture 1 | Complete Placement Course.
                        </h2>
                                    ...
                                    <div class="tab-pane fade show active" id="description">
                                        ...
                                        <div class="tab-description">
                                            <div class="description-wrapper">
                                                ...
                                                <p>Complete C++ Placement Course (Data Structures+Algorithm) :</p>
                                                
                                            </div>
                                            <div class="description-wrapper">
                                                <h3 class="tab-title">Curriculum:</h3>
                                                <p>Hey guys, welcome to this Course - Apna College. Here Shradha Didi and I(your Aman Bhaiya) will help you in finding your right college, career options, 
                                                    soft skills and will also help you learn to code. Chalo Phodte hain!
                                                </p>
                                            </div>
                                            <!--<div class="description-wrapper">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-widget widget-information">
                            ...
                            <div class="info-list">
                                <ul>
                                    <li><i class="fa fa-user"></i> <strong>Instructor</strong> <span>Apna College
                                            </span></li>
                                    <li><i class="fa fa-history"></i> <strong>Duration</strong> <span>20 hr 45
                                            mins</span></li>
                                    <li><i class="fa fa-play"></i> <strong>Lectures</strong> <span>34</span></li>
                            ...
                            <div class="info-btn">
                                <a href="Video/video.php" class="btn btn-primary btn-hover-dark">Enroll Now</a>
                            </div>
                        </div>
