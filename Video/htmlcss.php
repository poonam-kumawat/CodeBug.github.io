    ...
    <div class="section">
        ...
        <div class="courses-enroll-wrapper">
            ...
            <div class="courses-video-player">
                ...
                <iframe width="1070" height="690" src="https://www.youtube.com/embed/hu-q2zYwEYs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                ...
                <div class="courses-enroll-content">
                    ...
                    <div class="courses-enroll-title">
                        <h2 class="title">HTML & CSS Crash Course Tutorial </h2>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="enroll-tab-content">
                                                <p> welcome to your very first HTML & CSS tutorial. Throughout this crash course series I'll take you from total beginner to create great-looking sites with HTML & CSS. In this video, we'll cover what HTML & CSS are, as well as setting up our dev environment. </p>
                                                ...
                                                <p>HTML Tutorial for Beginners - Learn HTML for a career in web development. This HTML tutorial teaches you everything you need to get started.</p>
                    ...
                    <div class="accordion" id="videoPlaylist">
                        ...
                        <div class="accordion-item">
                            <button class="collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne">
                                <p>HTML & CSS Crash Course Tutorial </p>
                                <span class="total-duration">15 hours</span>
                            </button>

                            <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#videoPlaylist">
                                <nav class="vids">
                                    <a class="link active playing" href="https://www.youtube.com/embed/hu-q2zYwEYs">
                                   
                                        <p>HTML & CSS Crash Course Tutorial #1 - Introduction</p>
                                        <span class="total-duration">20 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/mbeT8mpmtHA">
                                        <p>HTML & CSS Crash Course Tutorial #2 - HTML Basics</p>
                                        <span class="total-duration">19 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/YwbIeMlxZAU">
                                        <p>HTML & CSS Crash Course Tutorial #3 - HTML Forms</p>
                                        <span class="total-duration">31 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/D3iEE29ZXRM">
                                        <p>HTML & CSS Crash Course Tutorial #4 - CSS Basics</p>
                                        <span class="total-duration">42 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/FHZn6706e3Q">
                                        <p>HTML & CSS Crash Course Tutorial #5 - CSS Classes & Selectors</p>
                                        <span class="total-duration">36 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/kGW8Al_cga4">
                                        <p>HTML & CSS Crash Course Tutorial #6 - HTML 5 Semantics</p>
                                        <span class="total-duration">14 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/25R1Jl5P7Mw">
                                        <p>HTML & CSS Crash Course Tutorial #7 - Chrome Dev Tools</p>
                                        <span class="total-duration">11 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/XQaHAAXIVg8">
                                        <p>HTML & CSS Crash Course Tutorial #8 - CSS Layout & Position</p>
