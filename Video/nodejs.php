    ...
    <div class="section">
        ...
        <div class="courses-enroll-wrapper">
            ...
            <div class="courses-video-player">
                ...
                <iframe width="1070" height="690" src="https://www.youtube.com/embed/yEHCfRWz-EI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                ...
                <div class="courses-enroll-content">
                    ...
                    <div class="courses-enroll-title">
                        <h2 class="title">Crash Course of Node Js</h2>
                        <p><i class="fa fa-eye"></i> <span>8,350</span> Students are <br> watching</p>
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="enroll-tab-content">
                                                <p>Node Js is the runtime environment for JavaScript.
In this video will talk about What is Node JS and Why it is so famous?
Will touch Javascript, Express, Angular, React, MEAN,  MERN, MongoDB.</p>
                    ...
                    <div class="accordion" id="videoPlaylist">
                        ...
                        <div class="accordion-item">
                            <button class="collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne">
                                <p>Crash course of nodejs</p>
                                <span class="total-duration">8 Hours</span>
                            </button>

                            <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#videoPlaylist">
                                <nav class="vids">
                                    <a class="link active playing" href="https://www.youtube.com/embed/yEHCfRWz-EI">
                                    
                                        <p>What is Node js? | Simplified Explanation</p>
                                        <span class="total-duration">08 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/JINE4D0Syqw">
                                        <p>Node JS Installation</p>
                                        <span class="total-duration">08 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/U5h97cFmj8I">
                                        <p>Getting Started with Node JS</p>
                                        <span class="total-duration">14 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/YSyFSnisip0">
                                        <p>How Node JS Works?</p>
                                        <span class="total-duration">9 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/M8nlgBQBxxo">
                                        <p>What is NPM? | Node JS</p>
                                        <span class="total-duration">08 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/zKIV3A_aOkY">
                                        <p>Modules in Node JS</p>
                                        <span class="total-duration">11 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/ZySsdm576wE">
                                        <p>fs (File System) Module in Node JS</p>
                                        <span class="total-duration">09 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/2ojkb44XObc">
                                        <p>Express in Node js | Web Framework</p>
                                        <span class="total-duration">18 minutes</span>
                                    </a>
                                    <a class="link" href="https://www.youtube.com/embed/vJEO57B05Sg">
                                        <p>Node JS Tutorial | Crash Course</p>
                                        <span class="total-duration">1 hour 20 minutes</span>
                                    </a>
                                </nav>
                            </div>
                        </div>
