    ...
    <div class="section login-header">
        ...
        <div class="login-header-wrapper navbar navbar-expand">
            ...
            <div class="login-header-search search-2 dropdown">
                <button class="search-toggle" data-bs-toggle="dropdown"><i class="fa fa-search"></i></button>
    ...
    <div class="section">
        ...
        <div class="courses-enroll-wrapper">
            ...
            <div class="courses-video-player">
                ...
                <iframe width="1070" height="690" src="https://www.youtube.com/embed/GtD93tVZDX4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                ...
                <div class="courses-enroll-content">
                    ...
                    <div class="courses-enroll-title">
                        <h2 class="title"> MySQL With Python And Data Science </h2>
                        <p><i class="fa fa-eye"></i> <span>6,350</span> Students are <br> watching</p>
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="enroll-tab-content">
                                                ...
                                                <p>In this Tutorial we will learn. How to install MongoDB, How to create new collections that store documents, You'll learn about the most common and used MongoDB shell commands to manage your documents. We will cover the different types of data that can be stored.You will gain confidence in how to preform CRUD operations i.e. Create, Read, Update and Delete data. Then the course will dive into much deeper MongoDB concepts like Projection, Using Sort, Skip, and Limit, Indexing, Aggregation, BackUp and Restore.</p>
                    ...
                    <div class="accordion" id="videoPlaylist">
                        ...
                        <div class="accordion-item">
                            <button class="collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne">
                                ...
                                <span class="total-duration">15 hours</span>
                            </button>

                            <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#videoPlaylist">
                                <nav class="vids">
                                    <a class="link active playing" href="https://www.youtube.com/embed/GtD93tVZDX4">
                                    
                                        <p>MongoDB Tutorial for Beginners 1 - Introduction to MongoDB + Installing MongoDB</p>
                                        <span class="total-duration">11 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/0ws3oIyqieY">
                                        <p>MongoDB Tutorial for Beginners 2 - Install MongoChef (now Studio 3T) (MongoDB GUI Tool)</p>
                                        <span class="total-duration">9 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/NcW07q9FiAc">
                                        <p>MongoDB Tutorial for Beginners 3 - Create Database and Drop Database</p>
                                        <span class="total-duration">7 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/9RqMh282OGc">
                                        <p>MongoDB Tutorial for Beginners 4 - Create Collection and Drop Collection</p>
                                        <span class="total-duration">5 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/TCT5ulUzfR8">
                                        <p>MongoDB Tutorial for Beginners 5 - Insert Documents</p>
                                        <span class="total-duration">5 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/FH4XRY6h8Fg">
                                        <p>MongoDB Tutorial for Beginners 6 - Query Document</p>
                                        <span class="total-duration">8 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/1avpbijGmBw">
                                        <p>MongoDB Tutorial for Beginners 7 - Query Document - AND OR Conditions</p>
                                        <span class="total-duration">6 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/0x7myKJqI44">
                                        <p>MongoDB Tutorial for Beginners 8 - MongoDB Update Document</p>
                                        <span class="total-duration">9 minutes</span>
                                    </a>
                                </nav>
                            </div>
