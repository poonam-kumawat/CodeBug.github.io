...
<body>
    ...
    <div class="section login-header">
        ...
        <div class="login-header-wrapper na1vbar navbar-expand">
        ...
        <div class="courses-enroll-wrapper">
            ...
            <div class="courses-video-player">
                ...
                <div class="vidcontainer">
                    <iframe width="1070" height="690" src="https://www.youtube.com/embed/oJbfyzaA2QA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                ...
                <div class="courses-enroll-content">
                    ...
                    <div class="courses-enroll-title">
                        <h2 class="title">PHP Front To Back  - Series full course of PHP
                                            Learn with traversy media</h2>
                    </div>
                    ...
                    <div class="accordion" id="videoPlaylist">
                        ...
                        <div class="accordion-item">
                            <button class="collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne">
                                <p>Lesson-01: PHP Front To Back - Series full course of PHP Learn with traversy media</p>
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#videoPlaylist">
                                <nav class="vids">
                                    <a class="link active playing" href="https://www.youtube.com/embed/6tCWiexc05U">
                                    <!--<iframe width="1070" height="690" src="https://www.youtube.com/embed/6tCWiexc05U" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
                                        <p>PHP Front To Back [Part 2] - PHP7 & Xammp Installation</p>
                                        <span class="total-duration">08 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/0Dp7Lt7iT3A" title="YouTube video player">
                                        <p>PHP Front To Back [Part 3] - Variables, Constants & Data Types</p>
                                        <span class="total-duration">15 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/9p9siksrSoU">
                                        <p>PHP Front To Back [Part 4] - Arrays</p>
                                        <span class="total-duration">13 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/5ggUfM6mvSk">
                                        <p>PHP Front To Back [Part 5] - Loops</p>
                                        <span class="total-duration">9 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/ApP1rgZ9OlY">
                                        <p>PHP Front To Back [Part 6] - Functions</p>
                                        <span class="total-duration">13 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/x6UDhaHVaeY">
                                        <p>PHP Front To Back [Part 7] - Conditionals & Comparison</p>
                                        <span class="total-duration">11 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/EHfr-edosmA" title="YouTube video player">
                                        <p>PHP Front To Back [Part 8] - Dates & Timestamps</p>
                                        <span class="total-duration">11 minutes</span>
                                    </a>

                                    <a class="link" href="https://www.youtube.com/embed/faknU12cs7Y">
                                        <p>PHP Front To Back [Part 9] - Include & Require</p>
                                        <span class="total-duration">08 minutes</span>
                                    </a>
                                    <a class="link" href="https://www.youtube.com/embed/oVJ0anq8yLA">
                                        <p>PHP Front To Back [Part 10] - $_SERVER Superglobal</p>
                                        <span class="total-duration">16 minutes</span>
                                    </a>
                                    <a class="link" href="https://www.youtube.com/embed/cIFUH3Qnd6s">
                                        <p>PHP Front To Back [Part 11] - Get & Post Tutorial</p>
                                        <span class="total-duration">13 minutes</span>
                                    </a>
                                    <a class="link" href="https://www.youtube.com/embed/z32BOHVWplU">
