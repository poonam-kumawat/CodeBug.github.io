                ...
                <div class="col-lg-8">
                    ...
                    <div class="courses-details">
                        ...
                        <div class="courses-details-images">
                            <img src="assets/images/courses/django.jpg" alt="Courses Details">
                            <span class="tags">Science</span>

                            <div class="courses-play">
                                <img src="Images/circle-shape.webp" alt="Play">
                                <a class="play video-popup" href="Video/django.php"><i
                                        class="fa fa-play"></i></a>
                            </div>
                        </div>

                        <h2 class="title">Python Django Tutorial: Full-Featured Web App.
                        </h2>

                        <div class="courses-details-admin">
                            <div class="admin-author">
                                <div class="author-thumb">
                                    <img src="assets/images/author/djangoauth.jpg" alt="Author">
                                </div>
                                <div class="author-content">
                                    <a class="name" href="#">Corey Schafer</a>
                                    
                                </div>
                            </div>
                            <div class="admin-rating">
                                <span class="rating-count">3.3</span>
                                    ...
                                    <div class="tab-pane fade show active" id="description">
                                        ...
                                        <div class="tab-description">
                                            <div class="description-wrapper">
                                                ...
                                                <p>Python Django Tutorial: Full-Featured Web App</p>
                                                
                                            </div>
                                            <div class="description-wrapper">
                                                <h3 class="tab-title">Curriculum:</h3>
                                                <p>In this Python Django Tutorial, we will be learning how to get started using the Django framework. We will install the necessary packages and get a basic application running in our browser. Let's get started. 
                                                </p>
                                            </div>
                                            <!--<div class="description-wrapper">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-widget widget-information">
                            ...
                            <div class="info-list">
                                <ul>
                                    <li><i class="fa fa-user"></i> <strong>Instructor</strong> <span>Corey Schafer

                                            </span></li>
                                    <li><i class="fa fa-history"></i> <strong>Duration</strong> <span>20 hr 
                                            mins</span></li>
                                    <li><i class="fa fa-play"></i> <strong>Lectures</strong> <span>17</span></li>
                            ...
                            <div class="info-btn">
                                <a href="Video/django.php" class="btn btn-primary btn-hover-dark">Enroll Now</a>
                            </div>
                        </div>
