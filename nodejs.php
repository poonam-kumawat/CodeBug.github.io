                ...
                <div class="col-lg-8">
                    ...
                    <div class="courses-details">
                        ...
                        <div class="courses-details-images">
                            <img src="assets/images/courses/nodejs.jpg" alt="Courses Details">
                            <span class="tags">Science</span>

                            <div class="courses-play">
                                <img src="Images/circle-shape.webp" alt="Play">
                                <a class="play video-popup" href="Video/nodejs.php"><i
                                        class="fa fa-play"></i></a>
                            </div>
                        </div>

                        <h2 class="title">Node js Series: Learn  What is Node js? | Simplified Explanation.
                        </h2>
                                    ...
                                    <div class="tab-pane fade show active" id="description">
                                        ...
                                        <div class="tab-description">
                                            <div class="description-wrapper">
                                                ...
                                                <p>Complete Nodejs Course To Learn:</p>
                                                
                                            </div>
                                            <div class="description-wrapper">
                                                <h3 class="tab-title">Curriculum:</h3>
                                                <p>Node Js is the runtime environment for JavaScript.<br>In this video will talk about What is Node JS and Why it is so famous?
                                                <br>Will touch Javascript, Express, Angular, React, MEAN,  MERN, MongoDB.
                                                </p>
                                            </div>
                                            <!--<div class="description-wrapper">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-widget widget-information">
                            ...
                            <div class="info-list">
                                <ul>
                                    <li><i class="fa fa-user"></i> <strong>Instructor</strong> <span>Telusko
                                            </span></li>
                                    <li><i class="fa fa-history"></i> <strong>Duration</strong> <span>7 hr 5
                                            mins</span></li>
                                    <li><i class="fa fa-play"></i> <strong>Lectures</strong> <span>9</span></li>
                            ...
                            <div class="info-btn">
                                <a href="Video/nodejs.php" class="btn btn-primary btn-hover-dark">Enroll Now</a>
                            </div>
                        </div>
